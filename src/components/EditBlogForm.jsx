...
const EditBlogForm = ({ blog }) => {
  ...
  const updateBlog = async (e) => {
    ...
    try {
      const response = await fetch(`${baseUrl}/api/blogs/${blog?._id}/edit`, {
        method: "PUT",
        headers: {
      ...
      throw new Error(error?.message || "failed to update the blog");
    }
  };
  ...
  // return the jsx
  return (
    <form onSubmit={updateBlog} className="addWebsiteform">
      {/* blog title */}
